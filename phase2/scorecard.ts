 ...
 *
 * This is intentionally simple — we're comparing structural similarity,
 * not doing audio analysis. The voice-parser already extracts:
 * voice names, types, synth, notes, effects, gain.
 */
...
CREATE TABLE IF NOT EXISTS curator_rewards (
  id              UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  pattern_id      UUID REFERENCES evolutions(id),
  code            TEXT NOT NULL,
  skill_id        VARCHAR(64) NOT NULL,
