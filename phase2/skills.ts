...
/**
 * Inject a dynamically generated skill into the registry.
 * Used by the vibe pipeline to register skills without writing to disk.
 */
export function injectSkill(skill: Skill): void {
  skills.set(skill.id, skill);
  console.log(`[skills] injected: ${skill.id} (${skill.name}) — generated`);
}
